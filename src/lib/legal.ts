/**
 * Datos compartidos por las páginas legales.
 *
 * La fecha vive acá y no escrita en cada página para que no queden diciendo
 * cosas distintas: si se corrige una cláusula hay que tocar un solo lugar, y
